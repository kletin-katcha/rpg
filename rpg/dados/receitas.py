...
# ---------------------------
# "id_item_criado": (str) ID do item que será produzido.
# "ingredientes": (list) Lista de dicionários, cada um com:
#   - "id_item": (str) ID do ingrediente necessário.
#   - "quantidade": (int) Quantidade necessária do ingrediente.
# "tipo_estacao": (str) O tipo de estação de trabalho necessária para
#   criar o item (ex: "forja", "bancada_alquimia", "fogueira").
# "nivel_habilidade_necessario": (int) [Opcional] Nível em uma habilidade
#   de crafting (ex: ferraria, alquimia) para poder criar.
#
# ==============================================================================
