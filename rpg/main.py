...
def main() -> None:
    ...
    while game.running:
        ...
        print("Dica: contrato_aleatorio -> concluir_contrato -> resgatar_beneficio_faccao para meta progressão; atalhos: lobo, goblin, forjar, oficina, automacao, dia, status, historico, arvore, help + salvar/carregar")
