...
def main() -> None:
    ...
    while game.running:
        ...
        print("Dica: use contrato_aleatorio + concluir_contrato para progresso de facção; atalhos: lobo, goblin, forjar, oficina, automacao, dia, status, historico, arvore, help + salvar/carregar")
